...
public class MboxReader extends MboxParser implements ItemReader<DtoEmail> {
    ...
    @Override
    public DtoEmail read() throws Exception, UnexpectedInputException, ParseException, NonTransientResourceException {
    ...
    private DtoEmail buildEmail(ByteArrayInputStream s) throws Exception {
